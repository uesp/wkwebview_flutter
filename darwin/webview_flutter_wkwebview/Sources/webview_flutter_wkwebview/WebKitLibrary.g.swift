...
protocol WebKitLibraryPigeonProxyApiDelegate {
  ...
  /// An implementation of [PigeonApiNSScrollView] used to add a new Dart instance of
  /// `NSScrollView` to the Dart `InstanceManager` and make calls to Dart.
  func pigeonApiNSScrollView(_ registrar: WebKitLibraryPigeonProxyApiRegistrar) -> PigeonApiNSScrollView
  ...
  /// An implementation of [PigeonApiFWFNSScrollViewDelegate] used to add a new Dart instance of
  /// `FWFNSScrollViewDelegate` to the Dart `InstanceManager` and make calls to Dart.
  func pigeonApiFWFNSScrollViewDelegate(_ registrar: WebKitLibraryPigeonProxyApiRegistrar) -> PigeonApiFWFNSScrollViewDelegate
...
open class WebKitLibraryPigeonProxyApiRegistrar {
  ...
  func setUp() {
    ...
    PigeonApiNSScrollView.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiNSScrollView(self))
    ...
    PigeonApiFWFNSScrollViewDelegate.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiFWFNSScrollViewDelegate(self))
  ...
  func tearDown() {
    ...
    PigeonApiNSScrollView.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    ...
    PigeonApiFWFNSScrollViewDelegate.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
...
private class WebKitLibraryPigeonInternalProxyApiCodecReaderWriter: FlutterStandardReaderWriter {
  ...
  private class WebKitLibraryPigeonInternalProxyApiCodecWriter: WebKitLibraryPigeonCodecWriter {
    ...
    override func writeValue(_ value: Any) {
      ...
      #endif
      #if !os(iOS)
      if let instance = value as? NSScrollView {
        pigeonRegistrar.apiDelegate.pigeonApiNSScrollView(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      #endif
      #if !os(iOS)
      if let instance = value as? FWFNSScrollViewDelegate {
        pigeonRegistrar.apiDelegate.pigeonApiFWFNSScrollViewDelegate(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
...
protocol PigeonApiDelegateNSScrollView {
  #if !os(iOS)
  /// The point at which the origin of the content view is offset from the
  /// origin of the scroll view.
  func getContentOffset(pigeonApi: PigeonApiNSScrollView, pigeonInstance: NSScrollView) throws -> [Double]
  #endif
  #if !os(iOS)
  /// Move the scrolled position of your view.
  func scrollBy(pigeonApi: PigeonApiNSScrollView, pigeonInstance: NSScrollView, x: Double, y: Double) throws
  #endif
  #if !os(iOS)
  /// The point at which the origin of the content view is offset from the
  /// origin of the scroll view.
  func setContentOffset(pigeonApi: PigeonApiNSScrollView, pigeonInstance: NSScrollView, x: Double, y: Double) throws
  #endif
  #if !os(iOS)
  /// The delegate of the scroll view.
  func setDelegate(pigeonApi: PigeonApiNSScrollView, pigeonInstance: NSScrollView, delegate: FWFNSScrollViewDelegate?) throws
  #endif
  #if !os(iOS)
  /// Whether the scroll view bounces past the edge of content and back again.
  func setBounces(pigeonApi: PigeonApiNSScrollView, pigeonInstance: NSScrollView, value: Bool) throws
  #endif
  #if !os(iOS)
  /// Whether the scroll view bounces when it reaches the ends of its horizontal
  /// axis.
  func setBouncesHorizontally(pigeonApi: PigeonApiNSScrollView, pigeonInstance: NSScrollView, value: Bool) throws
  #endif
  #if !os(iOS)
  /// Whether the scroll view bounces when it reaches the ends of its vertical
  /// axis.
  func setBouncesVertically(pigeonApi: PigeonApiNSScrollView, pigeonInstance: NSScrollView, value: Bool) throws
  #endif
  #if !os(iOS)
  /// Whether bouncing always occurs when vertical scrolling reaches the end of
  /// the content.
  func setAlwaysBounceVertical(pigeonApi: PigeonApiNSScrollView, pigeonInstance: NSScrollView, value: Bool) throws
  #endif
  #if !os(iOS)
  /// Whether bouncing always occurs when horizontal scrolling reaches the end
  /// of the content view.
  func setAlwaysBounceHorizontal(pigeonApi: PigeonApiNSScrollView, pigeonInstance: NSScrollView, value: Bool) throws
  #endif
  #if !os(iOS)
  /// Whether the vertical scroll indicator is visible.
  func setShowsVerticalScrollIndicator(pigeonApi: PigeonApiNSScrollView, pigeonInstance: NSScrollView, value: Bool) throws
  #endif
  #if !os(iOS)
  /// Whether the horizontal scroll indicator is visible.
  func setShowsHorizontalScrollIndicator(pigeonApi: PigeonApiNSScrollView, pigeonInstance: NSScrollView, value: Bool) throws
  #endif
}

protocol PigeonApiProtocolNSScrollView {
}

final class PigeonApiNSScrollView: PigeonApiProtocolNSScrollView  {
  unowned let pigeonRegistrar: WebKitLibraryPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateNSScrollView
  ///An implementation of [NSObject] used to access callback methods
  var pigeonApiNSObject: PigeonApiNSObject {
    return pigeonRegistrar.apiDelegate.pigeonApiNSObject(pigeonRegistrar)
  }

  init(pigeonRegistrar: WebKitLibraryPigeonProxyApiRegistrar, delegate: PigeonApiDelegateNSScrollView) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiNSScrollView?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: WebKitLibraryPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    #if !os(iOS)
    let getContentOffsetChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.NSScrollView.getContentOffset", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getContentOffsetChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! NSScrollView
        do {
          let result = try api.pigeonDelegate.getContentOffset(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
    ...
    #endif
    #if !os(iOS)
    let scrollByChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.NSScrollView.scrollBy", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      scrollByChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! NSScrollView
    ...
    #endif
    #if !os(iOS)
    let setContentOffsetChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.NSScrollView.setContentOffset", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setContentOffsetChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! NSScrollView
    ...
    #endif
    #if !os(iOS)
    let setDelegateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.NSScrollView.setDelegate", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setDelegateChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! NSScrollView
    ...
    #endif
    #if !os(iOS)
    let setBouncesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.NSScrollView.setBounces", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setBouncesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! NSScrollView
    ...
    #endif
    #if !os(iOS)
    let setBouncesHorizontallyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.NSScrollView.setBouncesHorizontally", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setBouncesHorizontallyChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! NSScrollView
    ...
    #endif
    #if !os(iOS)
    let setBouncesVerticallyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.NSScrollView.setBouncesVertically", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setBouncesVerticallyChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! NSScrollView
    ...
    #endif
    #if !os(iOS)
    let setAlwaysBounceVerticalChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.NSScrollView.setAlwaysBounceVertical", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setAlwaysBounceVerticalChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! NSScrollView
    ...
    #endif
    #if !os(iOS)
    let setAlwaysBounceHorizontalChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.NSScrollView.setAlwaysBounceHorizontal", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setAlwaysBounceHorizontalChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! NSScrollView
    ...
    #endif
    #if !os(iOS)
    let setShowsVerticalScrollIndicatorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.NSScrollView.setShowsVerticalScrollIndicator", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setShowsVerticalScrollIndicatorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! NSScrollView
    ...
    #endif
    #if !os(iOS)
    let setShowsHorizontalScrollIndicatorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.NSScrollView.setShowsHorizontalScrollIndicator", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setShowsHorizontalScrollIndicatorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! NSScrollView
  ...
  #if !os(iOS)
  ///Creates a Dart instance of NSScrollView and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: NSScrollView, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          PigeonError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.webview_flutter_wkwebview.NSScrollView.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
withIdentifier: pigeonIdentifierArg)
    ...
    #endif
    #if !os(iOS)
    let scrollViewChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.NSViewWKWebView.scrollView", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      scrollViewChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! WKWebView
...
protocol PigeonApiDelegateFWFNSScrollViewDelegate {
  #if !os(iOS)
  func pigeonDefaultConstructor(pigeonApi: PigeonApiFWFNSScrollViewDelegate) throws -> FWFNSScrollViewDelegate
  #endif
}

protocol PigeonApiProtocolFWFNSScrollViewDelegate {
  #if !os(iOS)
  /// Tells the delegate when the user scrolls the content view within the
  /// scroll view.
...
final class PigeonApiFWFNSScrollViewDelegate: PigeonApiProtocolFWFNSScrollViewDelegate  {
  unowned let pigeonRegistrar: WebKitLibraryPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateFWFNSScrollViewDelegate
  ///An implementation of [NSObject] used to access callback methods
  var pigeonApiNSObject: PigeonApiNSObject {
    return pigeonRegistrar.apiDelegate.pigeonApiNSObject(pigeonRegistrar)
  }

  init(pigeonRegistrar: WebKitLibraryPigeonProxyApiRegistrar, delegate: PigeonApiDelegateFWFNSScrollViewDelegate) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiFWFNSScrollViewDelegate?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: WebKitLibraryPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    #if !os(iOS)
    let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.FWFNSScrollViewDelegate.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonIdentifierArg = args[0] as! Int64
...
withIdentifier: pigeonIdentifierArg)
  ...
  #if !os(iOS)
  ///Creates a Dart instance of FWFNSScrollViewDelegate and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: FWFNSScrollViewDelegate, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          PigeonError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.webview_flutter_wkwebview.FWFNSScrollViewDelegate.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
  ...
  /// Tells the delegate when the user scrolls the content view within the
  /// scroll view.
  func scrollViewDidScroll(pigeonInstance pigeonInstanceArg: FWFNSScrollViewDelegate, scrollView scrollViewArg: NSScrollView, x xArg: Double, y yArg: Double, completion: @escaping (Result<Void, PigeonError>) -> Void)   {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          PigeonError(
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `FWFNSScrollViewDelegate.scrollViewDidScroll` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
